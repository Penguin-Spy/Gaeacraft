...
execute if score @s gaeacraft.count matches 7 run loot spawn ~ ~ ~ loot gaeacraft:blocks/rocks/diorite
execute if score @s gaeacraft.count matches 8 run loot spawn ~ ~ ~ loot gaeacraft:blocks/rocks/andesite
...
execute if score @s gaeacraft.count matches 6 run data modify entity @e[type=item,distance=0...5,nbt={Item:{tag:{silk_touch:0b}}},limit=1,sort=nearest] Item.tag set value {display:{Name:'{"translate":"item.gaeacraft.geo_res.malachite","italic":false}'},CustomModelData:106}
execute if score @s gaeacraft.count matches 9 run data modify entity @e[type=item,distance=0...5,nbt={Item:{tag:{silk_touch:0b}}},limit=1,sort=nearest] Item.tag set value {display:{Name:'{"translate":"item.gaeacraft.geo_res.limonite","italic":false}'},CustomModelData:109}
execute if score @s gaeacraft.count matches 10 run data modify entity @e[type=item,distance=0...5,nbt={Item:{tag:{silk_touch:0b}}},limit=1,sort=nearest] Item.tag set value {display:{Name:'{"translate":"item.gaeacraft.geo_res.hematite","italic":false}'},CustomModelData:110}
