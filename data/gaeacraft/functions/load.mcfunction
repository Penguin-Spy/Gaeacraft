...
tellraw @a[gamemode=creative] [{"translate":"description.gaeacraft.version","color":"green"},{"text":" ["},{"score": {"objective": "gaeacraft.ver","name": "$major"}},{"text":"."},{"score": {"objective": "gaeacraft.ver","name": "$minor"}},{"text":"."},{"score": {"objective": "gaeacraft.ver","name": "$patch"}},{"translate":"description.gaeacraft.version.suffix"},{"text":"] "},{"translate":"description.gaeacraft.version.loaded"}]
