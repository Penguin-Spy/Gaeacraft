...
#replace the summon-crafting_grid armorstand with a real crafting_grid (chest_minecart riding armorstand)
execute as @e[type=minecraft:armor_stand,tag=summon-crafting_grid] at @s run summon minecraft:armor_stand ~ ~-1.777 ~ {NoGravity:1b,Invisible:1b,Invulnerable:1b,Tags:["crafting_grid"],Passengers:[{id:"minecraft:chest_minecart",CustomDisplayTile:1b,Tags:["gc_invis_minecart","crafting_grid"],CustomName:'{"translate":"container.crafting","italic":false}',DisplayState:{Name:"minecraft:air"},Items:[{Slot:0b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000001}},{Slot:4b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:5b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:6b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:7b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:8b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:9b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:13b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:14b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:16b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:17b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:18b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:22b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:23b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:24b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:25b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}},{Slot:26b,id:"minecraft:feather",Count:1b,tag:{display:{Name:'{"translate":"empty","italic":false}'},CustomModelData:1000002}}]}],ArmorItems:[{},{},{},{id:"minecraft:feather",Count:1b,tag:{display:{Lore:['{"translate":"gaeacraft.item.error"}']},CustomModelData:1000003}}]}
kill @e[type=minecraft:armor_stand,tag=summon-crafting_grid]
...
execute as @e[type=minecraft:armor_stand,tag=crafting_grid] at @s positioned ~ ~.75 ~ unless entity @e[type=minecraft:chest_minecart,tag=crafting_grid,distance=0...75] run kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:feather",tag:{CustomModelData:1000002}}}]
...
scoreboard players set @a gc_count 0
#test for if a player is holding a crafting_grid gui feather item. MUST RUN FUNCTION AT PLAYER WHO's ITEM WAS CLEARED
execute as @a store result score @s gc_count run clear @s minecraft:feather{CustomModelData:1000001}
execute as @a[scores={gc_count=1..}] at @s as @e[type=minecraft:chest_minecart,tag=crafting_grid,distance=0..10] run function gaeacraft:gui/crafting/reset_gui
#test for if a player is holding an 'empty' feather item.
execute as @a store result score @s gc_count run clear @s minecraft:feather{CustomModelData:1000002}
execute as @a[scores={gc_count=1..}] at @s as @e[type=minecraft:chest_minecart,tag=crafting_grid,distance=0..10] run function gaeacraft:gui/crafting/reset_gui
execute as @a[scores={gc_count=1..}] at @s as @e[type=minecraft:chest_minecart,tag=knapping,distance=0..10] run function gaeacraft:gui/knapping/reset_gui
#test for if a player is holding a knapping gui feather item.
execute as @a store result score @s gc_count run clear @s minecraft:feather{CustomModelData:1000007}
execute as @a[scores={gc_count=1..}] at @s as @e[type=minecraft:chest_minecart,tag=knapping,distance=0..10] run function gaeacraft:gui/knapping/reset_gui
#test for if a player is holding a knapping button feather item.
#execute as @a store result score @s gc_count run clear @s minecraft:feather{CustomModelData:1000008}
execute as @a[scores={gc_count=1..}] run playsound minecraft:ui.button.click master @s
...
# Raycasting - disabled for now, needs updating to new version/removal because lag
#effect clear @a minecraft:mining_fatigue
#execute as @a at @s run function gaeacraft:raycasting/cast
scoreboard players set @a gc_sneakTime 0