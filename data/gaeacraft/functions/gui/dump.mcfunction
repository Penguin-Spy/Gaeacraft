...
data modify entity @s Items append from block 1 0 0 Items[{tag:{gaeacraft_temp:{gui_dont_dump:1b}}}]
...
data remove block 1 0 0 Items[{tag:{gaeacraft_temp:{gui_dont_dump:1b}}}]
