...
data modify entity @s Items append from block 1 0 0 Items[{id:"minecraft:feather",tag:{CustomModelData:10}}]
...
data modify entity @e[type=armor_stand,tag=gaeacraft.temp.knapping,limit=1] ArmorItems[3].tag.Items set from entity @s Items