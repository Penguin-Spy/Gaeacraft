...
tp @s ~ ~1.25 ~
execute store success score $success gaeacraft.count run data modify entity @s ArmorItems[3].tag.Items set from entity @e[type=chest_minecart,tag=gaeacraft.temp.knapping,limit=1] Items
