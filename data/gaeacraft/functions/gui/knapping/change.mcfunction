...
execute at @s as @p[tag=gaeacraft.player.gui_available.knapping] if score @s gaeacraft.player = @e[type=armor_stand,tag=gaeacraft.gui_cart.knapping,sort=nearest,limit=1] gaeacraft.player run function gaeacraft:gui/knapping/player
