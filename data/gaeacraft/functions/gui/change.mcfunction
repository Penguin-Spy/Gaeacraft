...
execute if entity @p[tag=gaeacraft.temp.minecart_gui,limit=1,tag=gaeacraft.player.gui_available.knapping.stone] as @e[type=chest_minecart,tag=gaeacraft.temp.minecart_gui,limit=1] run function gaeacraft:gui/knapping/detect
execute if entity @p[tag=gaeacraft.temp.minecart_gui,limit=1,tag=gaeacraft.player.gui_available.knapping.clay] as @e[type=chest_minecart,tag=gaeacraft.temp.minecart_gui,limit=1] run function gaeacraft:gui/knapping/detect
