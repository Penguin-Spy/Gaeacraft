...
data modify storage custom_crafting_table:craft Temp2 set from entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] Items[{Slot:15b}]


#get the output
execute if score @s craft_dimens_x matches 3 if score @s craft_dimens_y matches 3 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/3x3 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 2 if score @s craft_dimens_y matches 3 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/2x3 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 3 if score @s craft_dimens_y matches 2 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/3x2 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 1 if score @s craft_dimens_y matches 3 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/1x3 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 1 if score @s craft_dimens_y matches 2 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/1x2 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 3 if score @s craft_dimens_y matches 1 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/3x1 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 2 if score @s craft_dimens_y matches 2 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/2x2 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 2 if score @s craft_dimens_y matches 1 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/2x1 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 1 if score @s craft_dimens_y matches 1 run loot replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] container.15 fish gaeacraft:recipes/crafting_table/1x1 ~ ~ ~ mainhand
execute if score @s craft_dimens_x matches 0 if score @s craft_dimens_y matches 0 run data remove entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] Items[{Slot:15b}]

#copy output to Items[{Slot:15b}], and add the CCT_Display_Craft tag if an item was returned
data modify storage custom_crafting_table:craft Items[{Slot:15b}] merge from entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] Items[{Slot:15b}]
execute if data entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gc_cct_cart] Items[{Slot:15b}] run tag @s add CCT_Display_Craft
