...
execute if score Timer CustomCraftingT matches 1000.. as @e[type=armor_stand,tag=Custom_Crafting_Table,tag=gaeacraft.cct.cart] at @s run function custom_crafting_table:table/open
