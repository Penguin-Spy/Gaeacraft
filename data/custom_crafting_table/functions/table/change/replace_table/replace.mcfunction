...
execute unless entity @s[tag=CCT_Display_Craft] run replaceitem block ~ ~ ~ container.15 feather{CustomModelData:2,CCT_fill:1,CCT_GUI_Clear:1}
execute if score Book_Slot8 CustomCraftingT matches 0 run replaceitem block ~ ~ ~ container.8 feather{CustomModelData:2,CCT_fill:1,CCT_GUI_Clear:1}
