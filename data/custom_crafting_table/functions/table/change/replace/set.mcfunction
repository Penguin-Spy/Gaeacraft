...
execute unless score #timer CustomCraftingT matches 5.. if data storage custom_crafting_table:craft Test[0] run function custom_crafting_table:table/change/replace/set