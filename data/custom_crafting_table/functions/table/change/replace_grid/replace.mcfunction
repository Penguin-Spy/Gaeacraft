...
execute unless entity @s[tag=CCT_Display_Craft] run item entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gaeacraft.cct.chest_minecart] container.15 replace feather{CustomModelData:2,CCT_fill:1,CCT_GUI_Clear:1}
execute if score Book_Slot8 CustomCraftingT matches 0 run item entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest,tag=gaeacraft.cct.chest_minecart] container.8 replace feather{CustomModelData:2,CCT_fill:1,CCT_GUI_Clear:1}
